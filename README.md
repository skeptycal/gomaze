...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/gomaze/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/gomaze)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/gomaze"
```
...
go get github.com/xxxxxx/gomaze

cd ${GOPATH}/src/github.com/xxxxxx/gomaze
...
> This is a copy of the example script available in the `cmd/example/gomaze` folder:

```go
package main

import "github.com/skeptycal/gomaze"
...
[issues]: (https://github.com/skeptycal/gomaze/issues)
[pr]: (https://github.com/skeptycal/gomaze/pulls)
